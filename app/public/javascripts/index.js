/**
 * Created by famille on 2017-11-05.
 */
/*!
 ...
 * Date: 2013-1-14
 */
function FastButton(e, t) {
    this.element = e, this.handler = t, e.addEventListener("touchstart", this, !1)
}
function preventGhostClick(e, t) {
    coordinates.push(e, t), window.setTimeout(gpop, 2500)
}
function gpop() {
    coordinates.splice(0, 2)
}
function gonClick(e) {
    for (var t = 0; t < coordinates.length; t += 2) {
        var n = coordinates[t], r = coordinates[t + 1];
...
function goSomewhere() {
    var e = document.elementFromPoint(this.startX, this.startY);
...
(function (e, t) {
    ...
    function j(e, n, r, i) {
        ...
        var s, o, u = y.expando, a = typeof n == "string", l = e.nodeType, c = l ? y.cache : e,
            h = l ? e[u] : e[u] && u;
    ...
    function sn(e, t, n) {
        var r = !0, i = t === "width" ? e.offsetWidth : e.offsetHeight, s = Ft(e),
    ...
    function Yn(e, t, n) {
        var r, i, s = 0, o = Jn.length, u = y.Deferred().always(function () {
            ...
            if (i)return !1;
            var t = zn || Qn(), n = Math.max(0, f.startTime + f.duration - t), r = n / f.duration || 0, s = 1 - r,
    ...
    var n, r, i = e.document, s = e.location, o = e.jQuery, u = e.$, a = {}, f = [], l = "1.9.0", c = f.concat,
        h = f.push, p = f.slice, d = f.indexOf, v = a.toString, m = a.hasOwnProperty, g = l.trim, y = function (e, t) {
            return new y.fn.init(e, t, n)
        }, b = /[+-]?(?:\d*\.|)\d+(?:[eE][+-]?\d+|)/.source, w = /\S+/g, E = /^[\s\uFEFF\xA0]+|[\s\uFEFF\xA0]+$/g,
        S = /^(?:(<[\w\W]+>)[^>]*|#([\w-]*))$/, x = /^<(\w+)\s*\/?>(?:<\/\1>|)$/, T = /^[\],:{}\s]*$/,
        N = /(?:^|:|,)(?:\s*\[)+/g, C = /\\(?:["\\\/bfnrt]|u[\da-fA-F]{4})/g,
        k = /"[^"\\\r\n]*"|true|false|null|-?(?:\d+\.|)\d+(?:[eE][+-]?\d+|)/g, L = /^-ms-/, A = /-([\da-z])/gi,
        O = function (e, t) {
    ...
    y.Callbacks = function (e) {
        ...
        Deferred: function (e) {
            ...
            var t = 0, n = p.call(arguments), r = n.length, i = r !== 1 || e && y.isFunction(e.promise) ? r : 0,
    ...
    var R, U, z = /[\t\r\n]/g, W = /\r/g, X = /^(?:input|select|textarea|button|object)$/i, V = /^(?:a|area)$/i,
        $ = /^(?:checked|selected|autofocus|autoplay|async|controls|defer|disabled|hidden|loop|multiple|open|readonly|required|scoped)$/i,
        J = /^(?:checked|selected)$/i, K = y.support.getSetAttribute, Q = y.support.input;
    y.fn.extend({
        attr: function (e, t) {
        ...
        get: function (e, n) {
            var r = y.prop(e, n), i = typeof r == "boolean" && e.getAttribute(n),
                s = typeof r == "boolean" ? Q && K ? i != null : J.test(n) ? e[y.camelCase("default-" + n)] : !!i : e.getAttributeNode
                (n);
    ...
    var G = /^(?:input|select|textarea)$/i, Y = /^key/, Z = /^(?:mouse|contextmenu)|click/,
    ...
    y.event = {
        ...
        dispatch: function (e) {
            e = y.event.fix(e);
            var n, r, i, s, o, u = [], a = p.call(arguments), f = (y._data(this, "events") || {})[e.type] || [],
        ...
        function gt(e, t, n, r, i, s) {
            return r && !r[w] && (r = gt(r)), i && !i[w] && (i = gt(i, s)), st(function (s, o, u, a) {
                var f, l, c, h = [], p = [], d = o.length, v = s || wt(t || "*", u.nodeType ? [u] : u, []),
                    m = e && (s || !t) ? mt(v, h, e, u, a) : v, g = n ? i || (s ? e : d || r) ? [] : o : m;
                n && n(m, g, u, a);
                if (r) {
        ...
        function bt(e, t) {
            var n = 0, s = t.length > 0, o = e.length > 0, u = function (u, a, l, h, p) {
                var d, v, m, g = [], y = 0, b = "0", w = u && [], E = p != null, S = f,
                    T = u || o && i.find.TAG("*", p && a.parentNode || a), N = x += S == null ? 1 : Math.E;
                E && (f = a !== c && a, r = n);
                for (; (d = T[b]) != null; b++) {
                    if (o && d) {
        ...
        var n, r, i, s, o, u, a, f, l, c, h, p, d, v, m, g, b, w = "sizzle" + -(new Date), E = e.document, S = {},
            ...
            q = ":(" + B + ")(?:\\(((['\"])((?:\\\\.|[^\\\\])*?)\\3|((?:\\\\.|[^\\\\()[\\]]|" + I.replace(3, 8) + ")*)|.*)\\)|)",
            R = new RegExp("^" + H + "+|((?:^|[^\\\\])(?:\\\\.)*)" + H + "+$", "g"),
            U = new RegExp("^" + H + "*," + H + "*"), z = new RegExp("^" + H + "*([\\x20\\t\\r\\n\\f>+~])" + H + "*"),
            W = new RegExp(q), X = new RegExp("^" + j + "$"), V = {
                ID: new RegExp("^#(" + B + ")"),
                CLASS: new RegExp("^\\.(" + B + ")"),
    ...
    var it = /Until$/, st = /^(?:parents|prev(?:Until|All))/, ot = /^.[^:#\[\.,]*$/, ut = y.expr.match.needsContext,
    ...
    y.fn.extend({
        ...
        parent: function (e) {
            ...
            return y
                .sibling((e.parentNode || {}).firstChild, e)
        }, children: function (e) {
    ...
    var ht = "abbr|article|aside|audio|bdi|canvas|data|datalist|details|figcaption|figure|footer|header|hgroup|mark|meter|nav|output|progress|section|summary|time|video",
        pt = / jQuery\d+="(?:null|\d+)"/g, dt = new RegExp("<(?:" + ht + ")[\\s/>]", "i"), vt = /^\s+/,
        mt = /<(?!area|br|col|embed|hr|img|input|link|meta|param)(([\w:]+)[^>]*)\/>/gi, gt = /<([\w:]+)/,
        yt = /<tbody/i, bt = /<|&#?\w+;/, wt = /<(?:script|style|link)/i, Et = /^(?:checkbox|radio)$/i,
        St = /checked\s*(?:[^=]|=\s*.checked.)/i, xt = /^$|\/(?:java|ecma)script/i, Tt = /^true\/(.*)/,
        Nt = /^\s*<!(?:\[CDATA\[|--)|(?:\]\]|--)>\s*$/g, Ct = {
    ...
    var jt, Ft, It, qt = /alpha\([^)]*\)/i, Rt = /opacity\s*=\s*([^)]*)/, Ut = /^(top|right|bottom|left)$/,
        zt = /^(none|table(?!-c[ea]).+)/, Wt = /^margin/, Xt = new RegExp("^(" + b + ")(.*)$", "i"),
        Vt = new RegExp("^(" + b + ")(?!px)[a-z%]+$", "i"), $t = new RegExp("^([+-])=(" + b + ")", "i"),
        Jt = {BODY: "block"}, Kt = {position: "absolute", visibility: "hidden", display: "block"},
        Qt = {letterSpacing: 0, fontWeight: 400}, Gt = ["Top", "Right", "Bottom", "Left"],
        Yt = ["Webkit", "O", "Moz", "ms"];
    y.fn.extend({
        css: function (e, n) {
    ...
    var an = /%20/g, fn = /\[\]$/, ln = /\r?\n/g, cn = /^(?:submit|button|image|reset)$/i,
    ...
    var dn, vn, mn = y.now(), gn = /\?/, yn = /#.*$/, bn = /([?&])_=[^&]*/, wn = /^(.*?):[ \t]*([^\r\n]*)\r?$/mg,
        En = /^(?:about|app|app-storage|.+-extension|file|res|widget):$/, Sn = /^(?:GET|HEAD)$/, xn = /^\/\//,
        Tn = /^([\w.+-]+:)(?:\/\/([^\/?#:]*)(?::(\d+)|)|)/, Nn = y.fn.load, Cn = {}, kn = {}, Ln = "*/".concat("*");
    try {
        vn = s.href
    } catch (An) {
    ...
    dn = Tn.exec(vn.toLowerCase()) || [], y.fn.load = function (e, n, r) {
        ...
        ajax: function (e, n) {
            ...
            var r, i, s, o, u, a, f, l, c = y.ajaxSetup({}, n), h = c.context || c,
                p = c.context && (h.nodeType || h.jquery) ? y(h) : y.event, d = y.Deferred(),
                v = y.Callbacks("once memory"), m = c.statusCode || {}, g = {}, b = {}, E = 0, S = "canceled", x = {
    ...
    y.ajaxSetup({
        ...
        var s, o, u,
            a = n.jsonp !== !1 && (Bn.test(n.url) ? "url" : typeof n.data == "string" && !(n.contentType || "").indexOf("application/x-www-form-urlencoded") && Bn.test(n.data) && "data");
    ...
    var zn, Wn, Xn = /^(?:toggle|show|hide)$/, Vn = new RegExp("^(?:([+-])=|)(" + b + ")([a-z%]*)$", "i"),
        $n = /queueHooks$/, Jn = [er], Kn = {
            "*": [function (e, t) {
    ...
    y.Animation = y.extend(Yn, {
        ...
        fadeTo: function (e, t, n, r) {
            ...
            return e !== !1 && (e = e || "fx"), this.each(function () {
                var t, n = y._data(this), r = n[e + "queue"], i = n[e + "queueHooks"], s = y.timers,
                    o = r ? r.length : 0;
    ...
    e.rails = r = {
        ...
        handleRemote: function (n) {
            ...
            if (r.fire(n, "ajax:before")) {
                ...
                c = {
                    ...
                    }, xhrFields: {withCredentials: f}, crossDomain: a
                }, s && (c.url = s);
                var p = r.ajax(c);
        ...
        handleMethod: function (n) {
            var i = r.href(n), s = n.data("method"), o = n.attr("target"),
    ...
    }, r.fire(e(document), "rails:attachBindings"
        ...
        var i = e(this), s = i.data("remote") !== t, o = r.blankInputs(i, r.requiredInputSelector),
...
}(window.jQuery), FastButton.prototype.handleEvent = function (e) {
    switch (e.type) {
        case"touchstart":
            this.onTouchStart(e);
            break;
    ...
    e.stopPropagation(), this.element.addEventListener("touchend", this, !1), document.body.addEventListener("touchmove", this, !1), this.startX = e.touches[0].clientX, this.startY = e.touches[0].clientY, isMoving = !1
    ...
    this.reset(), this.handler(e), e.type == "touchend" && preventGhostClick(this.startX, this.startY)
}, FastButton.prototype.reset = function () {
    this.element.removeEventListener("touchend", this, !1), document.body.removeEventListener("touchmove", this, !1)
}, document.addEventListener("click", gonClick, !0);
var coordinates = [];
(function () {
}).call(this), $("document").ready(function () {
    var e = $("#beep")[0], t = $("#open")[0];
    $("li.expandable").each(function () {
        $(this).click(function () {
            $("#selected").removeAttr("id"), $(this).attr("id", "selected"), $("#audioSwitch").hasClass("active") && t.play()
        })
    }), $("icon").click(function () {
        $(this).toggleClass("active")
    }), $("#main").on("click", ".btn", function () {
        $(this).toggleClass("btn-active"), $("#audioSwitch").hasClass("active") && e.play()
    }), $("#main").html($("#sectionC").html()), $(".nav-c").click(function () {
        ...
        $("#main").html($("#sectionG").html())
    }), setDimensions = function () {
        var e = $(window).height() - 40, t = $(window).width() - 40;
        $("#nav ul").css("height", e + "px"), $(".hr-top").css("width", t - $("#nav ul").width() + "px"), $(".hr-top").css("margin-left", $("#nav ul").width() + "px"), $(".hr-bottom").css("width", t - $("#nav ul").width() + "px"), $(".hr-bottom").css("margin-left", $("#nav ul").width() + "px")
    }, $(window).resize(function () {
        setDimensions()
    }), initFastButtons(), setDimensions()
});